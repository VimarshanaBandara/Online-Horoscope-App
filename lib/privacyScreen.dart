  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 1.0,
        centerTitle: true,
        title: Text('Privacy & Policy',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0,shadows: <Shadow>[
          Shadow(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text('VM Mobile built the Online Horoscope/Daily/Weekly/Monthly/Yearly app as a Free app. This SERVICE is provided by VM Mobile at no cost and is intended for use as is.This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.\n\nIf you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.\n\nThe terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Online Horoscope/Daily/Weekly/Monthly/Yearly unless otherwise defined in this Privacy Policy.',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              SizedBox(height: 10.0,),
              Text('Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These are sent to your browser from the websites that you visit and are stored on your devices internal memory.\n\nThis Service does not use these “cookies” explicitly. However, the app may use third party code and libraries that use “cookies” to collect information and improve their services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this Service.',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              RaisedButton(
                ...
                color: Colors.blue,
                onPressed: () { launch('https://docs.google.com/document/d/1-0DHySbMSFtRN2V9Vi9XcCopnNiqNvHzqJrunycgkqc/edit?usp=sharing');},
              )
